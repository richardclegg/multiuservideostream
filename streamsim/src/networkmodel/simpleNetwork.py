...
class simpleNetwork (networkModel.networkModel):
    ...
    def parseJSON(self,js,fName):
        ...
        try:
            ...
            print >> sys.stderr,"JSON for simpleNetwork must",\
        ...
        while True:
            ...
            if len(parts) != 4 and len(parts) != 5:
                print >> sys.stderr,"Lines in simpleNetwork file", \
                    netFName,' are expected to be 4 tuple floats or ', \
                    ' 5 tuple with zone string as third arg', \
