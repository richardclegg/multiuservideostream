...
OUT_FILE="data/poker_var_best_ndynamic.out"
IN_FILE="scripts/poker_var_best_ndynamic.json"
SCRIPT=scripts/meansd.py
RND=$RANDOM
TMPJSONFILE="/tmp/poker_var_best_$RND.json"
TMPCOSTFILE="/tmp/poker_var_best_cost_$RND.out"
TMPDAYFILE="/tmp/poker_var_best_day_$RND.out"
TMPSESSFILE="/tmp/poker_var_best_sess_$RND.out"
TMPQOSFILE="/tmp/poker_var_best_qos_$RND.out"
rm -f $OUT_FILE
