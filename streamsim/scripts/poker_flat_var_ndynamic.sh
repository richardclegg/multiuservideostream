...
OUT_FILE="data/poker_flat_var_ndynamic.out"
IN_FILE="scripts/poker_flat_var_ndynamic.json"
SCRIPT=scripts/meansd.py
RND=$RANDOM
TMPJSONFILE="/tmp/poker_flat_var_$RND.json"
TMPCOSTFILE="/tmp/poker_flat_var_cost_$RND.out"
TMPDAYFILE="/tmp/poker_flat_var_day_$RND.out"
TMPSESSFILE="/tmp/poker_flat_var_sess_$RND.out"
TMPQOSFILE="/tmp/poker_flat_var_qos_$RND.out"
rm -f $OUT_FILE
